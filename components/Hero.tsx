    ...
    <section id="inicio" className="relative h-screen flex items-center bg-fitness-hero overflow-hidden">
      <div className="container mx-auto px-4 md:px-8 relative z-10">
        <div className="max-w-3xl">
          <div className="inline-flex items-center gap-2 bg-primary/20 border border-primary/30 px-3 py-1 rounded-full mb-6">
            <span className="w-2 h-2 bg-primary-light rounded-full animate-pulse"></span>
            <span className="text-primary-light text-xs font-bold uppercase tracking-widest">Energia & Saúde</span>
          </div>
